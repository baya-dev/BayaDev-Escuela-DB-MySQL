...
-- -----------------------------------------------------
-- Table `escuelas`.`tipopago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `escuelas`.`tipopago` (
...
CREATE TABLE IF NOT EXISTS `escuelas`.`configuracion` (
  ...
  `idperiodo` VARCHAR(11) NOT NULL,
  `idtipopago` INT NOT NULL,
  PRIMARY KEY (`idconfiguracion`, `idperiodo`, `idtipopago`),
  ...
  INDEX `fk_configuracion_tipopago1_idx` (`idtipopago` ASC) VISIBLE,
  CONSTRAINT `fk_configuracion_periododecalificacion1`
    FOREIGN KEY (`idperiodo`)
    REFERENCES `escuelas`.`periododecalificacion` (`idperiodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_configuracion_tipopago1`
    FOREIGN KEY (`idtipopago`)
    REFERENCES `escuelas`.`tipopago` (`idtipopago`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `escuelas`.`pagoescuela`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `escuelas`.`pagoescuela` (
  `idpagoescuela` INT NOT NULL,
  `fechapago` DATETIME NOT NULL,
  `monto` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idpagoescuela`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `escuelas`.`escuelas` (
  ...
  `idpagoescuela` INT NOT NULL,
  PRIMARY KEY (`idescuela`, `idpagoescuela`),
  ...
  INDEX `fk_escuelas_pagoescuela1_idx` (`idpagoescuela` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_escuelas_configuracion1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_escuelas_pagoescuela1`
    FOREIGN KEY (`idpagoescuela`)
    REFERENCES `escuelas`.`pagoescuela` (`idpagoescuela`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
